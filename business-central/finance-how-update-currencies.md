...
### <a name="effect-on-gl-accounts"></a><a name="effect-on-gl-accounts"></a>Auswirkungen auf Sachkonten
...
##### <a name="dimensions-on-gl-account-entries"></a><a name="dimensions-on-gl-account-entries"></a>Dimensionen in Sachposten
