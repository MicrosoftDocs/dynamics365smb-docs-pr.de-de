...
ms.author: edupont
---
# <a name="manage-many-incoming-document-records" />Mehrere eingehende Belege verwalten
...
## <a name="to-remove-incoming-document-records-from-the-default-view" />So entfernen Sie eingehende Belege aus der Standardansicht
...
## <a name="to-view-all-incoming-document-records" />So zeigen Sie alle eingehende Belege an
...
## <a name="to-add-incoming-document-records-to-the-default-view" />So fügen Sie eingehende Belege der Standardansicht hinzu
