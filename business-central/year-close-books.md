...
ms.author: jswymer
---
# <a name="closing-the-books"></a><a name="closing-the-books"></a><a name="closing-the-books"></a>Bucher schließen
...
## <a name="closing-book-process"></a><a name="closing-book-process"></a><a name="closing-book-process"></a>Prozess zum Abschließen der Bücher
...
## <a name="what-happens-when-you-close"></a><a name="what-happens-when-you-close"></a><a name="what-happens-when-you-close"></a>Was erfolgt, wenn Sie abschließen
