...
---
# <a name="register-employees" /><a name="register-employees"></a>Erfassen eines Mitarbeiters
...
## <a name="adding-new-employees" /><a name="adding-new-employees"></a>Hinzufügen neuer Mitarbeiter
...
## <a name="to-set-up-an-employee" /><a name="to-set-up-an-employee"></a>Einen Mitarbeiter einrichten:
...
## <a name="to-insert-a-picture-of-an-employee" /><a name="to-insert-a-picture-of-an-employee"></a>Das Bild eines Mitarbeiters einfügen:
...
## <a name="to-register-various-information-about-an-employee" /><a name="to-register-various-information-about-an-employee"></a>Erfassen von verschiedenen Informationen über einen Mitarbeiter
