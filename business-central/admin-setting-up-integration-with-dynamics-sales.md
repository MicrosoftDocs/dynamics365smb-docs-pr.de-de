...
## <a name="permissions-and-security-roles-for-user-accounts-in-" />Berechtigungen und Sicherheitsrollen für Benutzerkonten in [!INCLUDE[prod_short](includes/cds_long_md.md)]
