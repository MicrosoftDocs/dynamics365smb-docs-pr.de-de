...
Mehrwertsteuergruppenmitglieder und der Gruppenvertreter können die Anleitung zur unterstützten Einrichtung für die **Mehrwertsteuergruppen-Verwaltungseinrichtung** verwenden, um ihre Zusammenarbeit mit der Gruppe zu definieren und eine Verbindung zwischen ihren [!INCLUDE[d365fin](includes/d365fin_md.md)]-Mandanten zu erstellen. Die Gruppenmitglieder verwenden die Verbindung, um ihre Mehrwertsteuererklärung an den Gruppenvertreter zu senden. Der Vertreter übermittelt die Mehrwertsteuer an die Steuerbehörden im Auftrag der Gruppe mithilfe einer einzigen Mehrwertsteuererklärung. 
...
1. Wählen Sie das Symbol ![Glühbirne, das die Funktion „Sie wünschen...“ öffnet](media/ui-search/search_small.png "Was möchten Sie tun?") aus, geben Sie **Mehrwertsteuergruppe** ein und wählen Sie dann den zugehörigen Link.
