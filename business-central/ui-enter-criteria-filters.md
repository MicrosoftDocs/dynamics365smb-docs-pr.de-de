...
#### <a name="-greater-than"></a><a name="-greater-than"></a><a name="-greater-than"></a>(>) Größer als

|Beispielausdruck|Angezeigte Datensätze|  
|-----------------------|-----------------------|  
|`>1200`|Datensatznummern größer als 1200|  

#### <a name="-greater-than-or-equal-to"></a><a name="-greater-than-or-equal-to"></a><a name="-greater-than-or-equal-to"></a>(>=) Größer oder gleich
...
#### <a name="-case-insensitive"></a><a name="-case-insensitive"></a><a name="-case-insensitive"></a>(@) Groß-/Kleinschreibung beachten
