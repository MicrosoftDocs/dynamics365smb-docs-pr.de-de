...
ms.author: edupont
---
# <a name="use-allocation-keys-in-general-journals" />Zuordnungsschlüssel in Allgemeinen Buch.-Blättern verwenden
...
## <a name="to-change-an-allocation-key-that-has-already-been-set-up" />So ändern Sie einen bereits eingerichteten Zuordnungsschlüssel
1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet.](media/ui-search/search_small.png "Sagen Sie mir, was Sie tun möchten") Symbol. Geben Sie **Wiederk. Fibu Buch.-Blatt** ein und wählen Sie dann den zugehörigen Link.
