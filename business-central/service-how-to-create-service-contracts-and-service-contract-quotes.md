...
ms.author: bholtorf
---
# <a name="work-with-service-contracts-and-service-contract-quotes" />Arbeiten mit Serviceverträgen und Servicevertragsangeboten
...
## <a name="to-create-a-service-contract-or-service-contract-quote" />So erstellen Sie einen Servicevertrag oder ein Servicevertragsangebot
...
## <a name="to-convert-a-service-contract-quote-to-service-contract" />So wandeln Sie Servicevertragsangebote in Serviceverträge um
...
## <a name="to-add-a-contract-line-to-a-service-contract-or-contract-quote" />So fügen Sie einem Serviceauftrag oder einem Vertragsangebot Vertragszeilen hinzu
...
## <a name="to-add-a-contract-discount-to-service-contract-quotes" />So fügen Sie einen Vertragsrabatt für Servicevertragsangebote hinzu
...
## <a name="filing-a-service-contract-or-contract-quote" />Archivieren eines Servicevertrags oder Vertragsangebots
