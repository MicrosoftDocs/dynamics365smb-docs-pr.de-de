...
1. Wählen Sie das ![Glühbirne, die das „Sie wünschen ...“-Feature öffnet.](media/ui-search/search_small.png "Wie möchten Sie weiter verfahren") Symbol, geben Sie  **Wiederkehrende Hauptbucheinträge** ein und wählen Sie dann das zugehörige verknüpfen aus.
...
8. Erstellen Sie für jede Verteilung eine Zeile. Sie müssen entweder das Feld **Verteilung %**, **Anzahl Verteilungen** oder **Betrag** ausfüllen. Sie müssen auch das Feld  **Kontonr.**  und, wenn Sie die Transaktion auf globale Dimensionen aufteilen, die Felder globale Dimension ausfüllen.
...
1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren-Funktion öffnet.](media/ui-search/search_small.png "Wie möchten Sie weiter verfahren") Symbol, geben Sie  **Wiederkehrende Hauptbucheinträge** ein und wählen Sie dann das zugehörige verknüpfen aus.
2. Auswählen Sie auf der Seite  **Wiederkehrende Hauptbücher**  das Journal mit der Zuordnung.
