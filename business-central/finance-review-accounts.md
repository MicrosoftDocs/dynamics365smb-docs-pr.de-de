---
title: Hauptbuchkonten überprüfen
...
# <a name="review-amounts-in-general-ledger-accounts"></a>Beträge in Hauptbuchkonten überprüfen
...
> [!TIP]
> Eine schnelle Möglichkeit, mehrere Einträge auszuwählen, besteht darin, die Strg- oder Umschalttaste gedrückt zu halten, während Sie die Einträge auswählen. *Mit Strg* können Sie bestimmte Einträge auswählen, und mit  *Umschalt* können Sie alle Einträge zwischen dem ersten und dem letzten Eintrag auswählen, den Sie Auswählen.
...
[Verstehen Sie das Hauptbuch und den Kontenplan](finance-general-ledger.md)    
