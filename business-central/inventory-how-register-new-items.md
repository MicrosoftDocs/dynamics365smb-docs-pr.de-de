...
3. Um Dimensionen in Vorlagen wiederzuverwenden, wählen Sie die  **Verwandte** Aktion, dann  **Element** und anschließend  **Dimensionen**. Die  **Standardabmessungen** für den ausgewählten Artikel werden geöffnet und zeigen alle für den Artikel eingerichteten Dimensionscodes an.
