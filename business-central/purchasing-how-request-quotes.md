...
ms.author: edupont
---
# <a name="request-quotes"></a><a name="request-quotes"></a>Angebotsanforderungen
...
## <a name="create-a-purchase-quote"></a><a name="create-a-purchase-quote"></a>Erstellen Sie eine Einkaufsanfrage
...
## <a name="convert-a-purchase-quote-to-a-purchase-order"></a><a name="convert-a-purchase-quote-to-a-purchase-order"></a>Konvertieren Sie eine Einkaufsanfrage in eine Einkaufsbestellung
