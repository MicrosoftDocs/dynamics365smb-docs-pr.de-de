...
ms.author: edupont
---
# <a name="setting-up-source-codes-and-reason-codes-for-audit-trails"></a><a name="setting-up-source-codes-and-reason-codes-for-audit-trails"></a>Herkunftscodes und Ursachencodes für Audit Trails einrichten
...
## <a name="define-source-codes"></a><a name="define-source-codes"></a>Herkunftscodes definieren
...
### <a name="to-define-source-codes"></a><a name="to-define-source-codes"></a>So definieren Sie Herkunftscodes
...
## <a name="change-source-codes"></a><a name="change-source-codes"></a>Herkunftscodes ändern

Sie können einen Herkunftscode ändern. Sie können den Herkunftscode *FIBUBUCHBL* beispielsweise in *FIBUBL* ändern.

### <a name="to-change-source-codes"></a><a name="to-change-source-codes"></a>So ändern Sie Herkunftscodes
...
### <a name="to-assign-reason-codes-to-journal-templates"></a><a name="to-assign-reason-codes-to-journal-templates"></a>So weisen Sie Buch.-Blattvorlagen Ursachencodes zu
