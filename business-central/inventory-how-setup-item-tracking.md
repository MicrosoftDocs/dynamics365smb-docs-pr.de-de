...
ms.author: edupont
---
# <a name="set-up-item-tracking-with-serial-lot-and-package-numbers"></a><a name="set-up-item-tracking-with-serial-lot-and-package-numbers"></a><a name="set-up-item-tracking-with-serial-lot-and-package-numbers"></a>Artikelverfolgung mit Serien-, Chargen- und Paketnummern einrichten
...
## <a name="numbers-and-item-tracking"></a><a name="numbers-and-item-tracking"></a><a name="numbers-and-item-tracking"></a>Zahlen‑ und Artikelverfolgung
...
## <a name="to-set-up-items-for-tracking-with-the-correct-item-tracking-codes"></a><a name="to-set-up-items-for-tracking-with-the-correct-item-tracking-codes"></a><a name="to-set-up-items-for-tracking-with-the-correct-item-tracking-codes"></a>So richten Sie Artikel für die Verfolgung mit den richtigen Artikelverfolgungscodes ein
...
### <a name="item-journals"></a><a name="item-journals"></a><a name="item-journals"></a>Artikel-Blätter
