---
title: Kostenrechnung einrichten
...
# <a name="set-up-cost-accounting"></a>Kostenrechnung einrichten
...
## <a name="set-up-cost-types"></a>Kostenarten einrichten
...
1. Richten Sie eine Dimension als Kostenstellendimension auf der Seite **Kostenrechnungseinrichtung** ein. Es werden nur die Werte aus dieser Dimension übertragen.
Sie können die Aktion  **Kostenrechnungsdimensionen aktualisieren**  auswählen, um die Kostenrechnungsdimensionen zu aktualisieren.
1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion 2.](media/ui-search/search_small.png "Sagen Sie mir, was Sie tun möchten") öffnet. Symbol. Geben Sie **Kostenstellenplan** ein, und wählen Sie dann den entsprechenden Link.  
...
> [!NOTE]  
>  Um sicherzustellen, dass die vordefinierten Kostenstellen und Kostenträger, die Sie im Hauptbuch eingerichtet haben, automatisch in die Kostenrechnung übernommen werden, aktivieren Sie auf der Seite  **Kostenrechnung einrichten**  das Kontrollkästchen  **Hauptbuchbuchungen prüfen** .
