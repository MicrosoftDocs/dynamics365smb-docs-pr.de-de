...
1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet.](media/ui-search/search_small.png "Sagen Sie mir, was Sie tun möchten") Symbol. Geben Sie **Maßeinheiten** ein, und wählen Sie dann den entsprechenden Link.  
...
Wenn Sie Artikel an ausländische Kunden verkaufen, möchten Sie vielleicht die Maßeinheit in der Sprache des Debitors angeben. Das können Sie tun, indem Sie Übersetzungen für Maßeinheiten angeben.
