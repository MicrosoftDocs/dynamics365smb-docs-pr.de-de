...
## <a name="enable-or-disable-create-ai-powered-product-descriptions-with-copilot"></a><a name="enable-or-disable-create-ai-powered-product-descriptions-with-copilot"></a>Aktivieren oder deaktivieren Sie das Erstellen von KI-unterstützten Produktbeschreibungen mit Copilot
