...
## <a name="to-set-up-fixed-asset-journal-templates" />So richten Sie Anlagen Buch.-Blattvorlagen ein
...
## <a name="to-set-up-fixed-asset-journal-batches" />So richten Sie Anlagen Buch.-Blattnamen ein
...
## <a name="to-set-up-fixed-asset-reclassification-journal-batches" />So richten Sie Anlagen-Umbuchungsblätter ein
