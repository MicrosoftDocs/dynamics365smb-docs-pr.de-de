...
In den nachfolgenden Schritten wird beschrieben, wie ein alternativer Arbeitsplatzkalender eingerichtet wird. Die Schritte, um ein Arbeitsplatzkalenders einzurichten außer für das **Arbeitsplatz-Einrichtung** Inforegister.  
...
- Eine Effizienz von 200 % bedeutet, dass Sie die Arbeit in einer Stunde erledigen können. Sie können das Loch doppelt so schnell graben, wenn Sie einen Bagger haben, der doppelt so groß ist wie der kleinere.  

    Das gleiche Ergebnis können Sie erzielen, wenn Sie statt einem großen Bagger zwei kleinere verwenden. Verwenden Sie *2* als Kapazität und *100 %* als Effizienz.  
...
- Eine Effizienz von 200 % bedeutet, dass Sie die Einrichtung in 1 Stunde statt in 2 Stunden abschließen können, die in der Routinglinie definiert sind.  
