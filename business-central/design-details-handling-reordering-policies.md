...
---
# <a name="design-details-handling-reordering-policies"></a><a name="design-details-handling-reordering-policies"></a>Designdetails: Umgang mit Wiederbeschaffungsrichtlinien
...
## <a name="stay-below-the-overflow-level"></a><a name="stay-below-the-overflow-level"></a>Unter dem Überlauflevel bleiben
...
### <a name="calculating-the-overflow-level"></a><a name="calculating-the-overflow-level"></a>Berechnung des Überlauflevels
...
#### <a name="order-multiple"></a><a name="order-multiple"></a>Losgrößenrundungsfaktor
