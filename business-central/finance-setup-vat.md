...
# <a name="set-up-calculations-and-posting-methods-for-value-added-tax" />Berechnungen einrichten und Buchungsmethoden für Mehrwertsteuer
...
## <a name="set-up-vat-using-the-assisted-setup-guide-recommended" />Verwenden der Anleitung zur unterstützten Einrichtung der Mehrwertsteuer (empfohlen)
...
## <a name="set-up-a-default-vat-date-for-documents-and-journals" />Richten Sie ein Standard-MwSt.-Datum für Dokumente und Journale ein
...
## <a name="set-up-vat-product-posting-groups" />Legen Sie MwSt.-Produktbuchungsgruppen fest
...
## <a name="combine-vat-posting-groups-in-vat-posting-setups" />Kombinieren Sie MwSt.-Buchungsgruppen in MwSt.-Buchungseinrichtungen
...
## <a name="assign-vat-posting-groups-by-default-to-multiple-entities" />Weisen Sie VAT-Buchungsgruppen standardmäßig mehreren Entitäten zu
...
## <a name="assign-vat-posting-groups-to-accounts-customers-vendors-items-and-resources" />Weisen Sie Konten, Debitor, Kreditor, Artikel und Ressourcen Buchungsgruppen für die Mehrwertsteuer zu.

Die folgenden Abschnitten beschreiben, wie die MwSt.-Buchungsgruppen einzelnen Einheiten zugewiesen werden.

### <a name="to-assign-vat-posting-groups-to-individual-general-ledger-accounts" />So weisen Sie MwSt.-Buchungsgruppen einzelnen Sachkonten zu
...
## <a name="set-up-clauses-to-explain-vat-exemption-or-non-standard-vat-rates" />Festlegen von Klauseln zur Erklärung der MwSt.-Befreiung oder von nicht standardmäßigen MwSt.-Sätzen
...
### <a name="to-specify-extended-text-for-vat-clauses" />So legen Sie Textbausteine für Mehrwertsteuerklauseln fest
...
## <a name="create-a-vat-posting-setup-to-handle-import-vat" />Erstellen Sie eine MwSt.-Buchungseinrichtung zur Behandlung der Import-MwSt.
...
## <a name="use-reverse-charge-vat-for-trade-between-eu-countries-or-regions" />Verwenden Sie Reverse Charge VAT für den Handel zwischen EU-Ländern oder Regionen
...
## <a name="vat-rounding-for-documents" />Mehrwertsteuer-Rundung für Belege
...
## <a name="set-up-vat-reporting" />MwSt.-Berichte festlegen
