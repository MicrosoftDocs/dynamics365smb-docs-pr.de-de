...
## Verwenden der Anleitung zur unterstützten Einrichtung der Mehrwertsteuer (empfohlen)
...
2. Öffnen Sie das  **Sachkonto Karte** für das Konto.  
...
1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion 10.](media/ui-search/search_small.png "Was möchten Sie tun?") öffnet. aus, geben Sie **MwSt.-Buchungseinrichtung** ein, und wählen Sie dann den entsprechenden Link aus.  
...
## Erwerbssteuer für den Handel zwischen EU-Ländern/-Regionen verwenden
...
[Einrichten von Vorlagen und Namen für Umsatzsteuerabrechnungen](finance-how-setup-vat-statement.md)    
...
[Lokale Funktionalität in Business Central](about-localization.md)    
[Umsatzsteuer-Reporting in der deutschen Version](LocalFunctionality/Germany/vat-reporting.md)    
[Belgische Mehrwertsteuer](LocalFunctionality/Belgium/belgian-vat.md)    
[Italienische Mehrwertsteuer](LocalFunctionality/Italy/italian-vat.md)    
[Einrichten elektronischer Mehrwertsteuer- und ICP-Erklärungen in der niederländischen Version](LocalFunctionality/Netherlands/how-to-set-up-electronic-vat-and-icp-declarations.md)    
[Mehrwertsteuerberichte in der spanischen Version](LocalFunctionality/Spain/vat-reports.md)    
[Einrichten der Waren- und Dienstleistungssteuerbuchung in der australischen Version](LocalFunctionality/Australia/how-to-set-up-goods-and-service-tax-posting.md)    
[Mehrwertsteuer in der tschechischen Version](LocalFunctionality/Czech/finance-vat.md)    
[Mehrwertsteuerberichterstattung in der norwegischen Version](LocalFunctionality/Norway/norwegian-vat-reporting.md)    
