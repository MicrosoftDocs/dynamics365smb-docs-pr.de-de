---
title: Fehlerbehebung und Korrektur der Abmessungen
...
# <a name="troubleshoot-and-correct-dimensions"></a>Fehlerbehebung und Korrektur der Abmessungen
...
### <a name="correct-a-dimension"></a>Korrigieren einer Dimension
...
1. Verwenden Sie eine der folgenden Seiten, um eine Dimensionskorrektur zu starten:
    ...
    * Wählen Sie auf der Seite  **Sachregister**  ein Register aus und wählen Sie anschließend die Aktion  **Dimensionen korrigieren** . Diese Aktion startet eine Korrektur für die Posten im ausgewählten Journal.
    * Wählen Sie auf der Seite  **Hauptbucheinträge**  die Aktion  **Dimensionen korrigieren**  aus. 
...
5. Um die Korrektur zu bestätigen, wählen Sie **Dimensionsänderungen überprüfen** aus. Weitere Informationen finden Sie unter  [Validieren von Dimensionskorrekturen](finance-troubleshooting-correcting-dimensions.md#validate-dimension-corrections).
6. Wählen Sie **Ausführen** aus.

### <a name="validate-dimension-corrections"></a>Dimensionskorrekturen validieren
...
### <a name="handle-incomplete-corrections"></a>Unvollständige Korrekturen bearbeiten
