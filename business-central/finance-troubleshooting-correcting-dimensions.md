...
### <a name="dimension-corrections-on-large-data-sets" />Dimensionskorrekturen bei großen Datenmengen
...
### <a name="use-cost-accounting-with-corrected-gl-entries" />Verwenden von Kostenrechnung mit korrigierten Sachkonteneinträgen
