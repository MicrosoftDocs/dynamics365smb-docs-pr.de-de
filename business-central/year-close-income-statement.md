...
---
# <a name="closing-income-statement-accounts" /><a name="closing-income-statement-accounts"></a>GuV-Konten Nullstellung
...
## <a name="to-run-the-close-income-statement-batch-job" /><a name="to-run-the-close-income-statement-batch-job"></a>Verwenden Sie dazu den Stapelverarbeitungsjob GuV-Konten Nullstellung.
...
## <a name="about-the-close-income-statement-batch-job" /><a name="about-the-close-income-statement-batch-job"></a>Mehr Informationen zum Stapelverarbeitungsjob GuV-Konten Nullstellung.
