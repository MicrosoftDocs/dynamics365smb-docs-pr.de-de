...
### <a name="depreciation-period"></a><a name="depreciation-period"></a>AfA Periode
...
## <a name="db1sl-depreciation"></a><a name="db1sl-depreciation"></a>Degressiv/Lineare AfA 1
...
### <a name="example---db1-sl-depreciation"></a><a name="example---db1-sl-depreciation"></a>Beispiel – Degressiv-Lineare AfA 1
...
## <a name="half-year-convention-depreciation"></a><a name="half-year-convention-depreciation"></a>AfA 1 unter Verwendung der US-Halbjahresregel
...
### <a name="example---half-year-convention-depreciation"></a><a name="example---half-year-convention-depreciation"></a>Beispiel – AfA 1 unter Verwendung der US-Halbjahresregel
...
## <a name="example---db1sl-depreciation-using-half-year-convention"></a><a name="example---db1sl-depreciation-using-half-year-convention"></a>Beispiel – Degressiv/Lineare AfA 1 unter Verwendung der US-Halbjahresregel
