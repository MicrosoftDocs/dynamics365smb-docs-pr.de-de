...
|Strg+Pos1<br />(STRG+NACH-LINKS-TASTE)|Wählen Sie die erste Zeile in der Liste aus; Fokus springt zum ersten Feld in der Zeile, das eine Aktion erfordert.|Navigieren zur Kachel in der ersten Zeile der Liste||
|Strg+Ende<br />(STRG+NACH-RECHTS-TASTE)|Wählen Sie die letzte Zeile in der Liste aus; Fokus springt zum ersten Feld in der Zeile, das eine Aktion erfordert.|Navigieren zur ersten Kachel in der letzten Zeile der Liste||
...
|Umschalt+Linksklick|Erweitern Sie die Auswahl von Zeilen, um die Zeile einzuschließen, die Sie anklicken und alle Zeilen dazwischen.|Nicht anwendbar|Sie können dieses verwenden, nachdem Sie STRG+NACH-OBEN-TASTE oder STRG+NACH-OBEN-TASTE unten verwenden, um Ihre Auswahl zu erweitern.|
...
|STRG+LEERTASTE<br />(Ctrl+Cmd+Leertaste)|Erweitern Sie die Auswahl von Zeilen, um die fokussierte Zeile einzuschließen.|Nicht anwendbar|Sie können dieses verwenden, nachdem Sie STRG+NACH-OBEN-TASTE oder STRG+NACH-OBEN-TASTE unten verwenden, um Ihre Auswahl zu erweitern.|
|Strg+A|Alle Zeilen auswählen.|Nicht anwendbar||
|PFEILTASTE NACH OBEN UND UMSCHALTTASTE|Erweitern Sie die Auswahl von Zeilen, um die Zeile darüber einzuschließen.|Nicht anwendbar||
|Umschalt+Pfeil nach unten|Erweitern Sie die Auswahl von Zeilen, um die Zeile darunter einzuschließen.|Nicht anwendbar||
|Umschalt+Seite nach Oben<br />(PFEILTASTE NACH OBEN + FN + UMSCHALTTASTE)|Erweitern Sie die Auswahl von Zeilen, um alle sichtbaren Zeilen über der aktuellen Auswahl von Zeilen zu berücksichtigen.|Nicht anwendbar||
