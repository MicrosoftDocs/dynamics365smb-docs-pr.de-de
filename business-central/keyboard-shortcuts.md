...
|Drücken Sie diese Tasten<br />(in Mac Os)|Um dies in einer Listenansicht tun |Um dies in einer Listenansicht tun |Bemerkungen|
|-----------------|-------|-------|-------|
|Strg+Pos1<br />(STRG+NACH-LINKS-TASTE)|Wählen Sie die erste Zeile in der Liste aus; Fokus springt zum ersten Feld in der Zeile.|Navigieren zum ersten Feld in einer Zeile. ||
|Strg+Ende<br />(STRG+NACH-RECHTS-TASTE)|Wählen Sie die letzte Zeile in der Liste aus; Fokus springt zum letzten Feld in der Zeile.|Navigieren zur letzten Kachel in einer Zeile.||
