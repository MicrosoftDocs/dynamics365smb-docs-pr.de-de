...
description: 'In diesem Artikel wird erläutert, wie Sie Kauftransaktionen mit Drittanbietern innerhalb der Europäischen Union (EU) einrichten und verwenden.'
author: altotovi
ms.topic: conceptual
ms.devlang: al
...
1. Wählen Sie das ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet.](media/ui-search/search_small.png "Was möchten Sie tun?") Symbol, geben Sie  **Einkaufsrechnungen**  (oder ein anderes Einkaufsdokument) ein und Auswählen dann das zugehörige verknüpfen.
...
1. Wählen Sie das ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet.](media/ui-search/search_small.png "Was möchten Sie tun?") Symbol, geben Sie  **Mehrwertsteuererklärungen** und dann Auswählen das zugehörige verknüpfen ein.
