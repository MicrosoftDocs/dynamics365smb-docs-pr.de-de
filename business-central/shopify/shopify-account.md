...
- Deaktivieren Sie **Den Auftrag automatisch archivieren** im Abschnitt **Auftragsverarbeitung** der [**Kasse**](https://www.shopify.com/admin/settings/checkout)-Einstellungen in Ihrer **Shopify-Verwaltung**.
- Erwägen Sie die Auswahl der Option *Unternehmensname – optional* im Abschnitt **Debitoreninformationen** der Kasseneinstellungen.
