...
# <a name="synchronize-customers"></a><a name="synchronize-customers"></a>Debitoren synchronisieren
...
## <a name="important-settings-when-importing-customers-from-shopify"></a><a name="important-settings-when-importing-customers-from-shopify"></a>Wichtige Einstellungen beim Import von Debitoren aus Shopify
...
### <a name="customer-template-per-country"></a><a name="customer-template-per-country"></a>Debitorenvorlage pro Land
...
## <a name="export-customers-to-shopify"></a><a name="export-customers-to-shopify"></a>Debitoren nach Shopify exportieren
...
### <a name="populate-customer-information-in-shopify"></a><a name="populate-customer-information-in-shopify"></a>Debitoreninformationen in Shopify ausfüllen
...
## <a name="sync-customers"></a><a name="sync-customers"></a>Debitoren synchronisieren
