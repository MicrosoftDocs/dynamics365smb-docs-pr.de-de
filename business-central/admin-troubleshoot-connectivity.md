...
ROBOTS: NOINDEX
---
# <a name="troubleshoot-connectivity-for-business-central" />Problembehandlung der Konnektivität für Business Central
...
## <a name="start-the-connectivity-check" />Starten Sie die Konnektivitätsprüfung
...
## <a name="basic-internet-connectivity" />Grundlegende Internet-Konnektivität
...
## <a name="cdn-content-delivery-network-resources-loading" />CDN (Content Delivery Network)-Ressourcen werden geladen
...
## <a name="user-authentication" />Benutzer-Authentifizierung
...
## <a name="business-central-environments-discovery" />Erkennung von Business Central-Umgebungen
...
## <a name="application-service-connectivity" />Konnektivität der Anwendungsdienste
...
## <a name="web-server-connectivity" />Webserver-Konnektivität
...
## <a name="service-health-status" />Dienststatus
