...
ROBOTS: NOINDEX
---
# <a name="troubleshoot-connectivity-for-business-central"></a><a name="troubleshoot-connectivity-for-business-central"></a><a name="troubleshoot-connectivity-for-business-central"></a>Problembehandlung der Konnektivität für Business Central
...
## <a name="start-the-connectivity-check"></a><a name="start-the-connectivity-check"></a><a name="start-the-connectivity-check"></a>Starten Sie die Konnektivitätsprüfung
...
## <a name="basic-internet-connectivity"></a><a name="basic-internet-connectivity"></a><a name="basic-internet-connectivity"></a>Grundlegende Internet-Konnektivität
...
## <a name="cdn-content-delivery-network-resources-loading"></a><a name="cdn-content-delivery-network-resources-loading"></a><a name="cdn-content-delivery-network-resources-loading"></a>CDN (Content Delivery Network)-Ressourcen werden geladen
...
## <a name="user-authentication"></a><a name="user-authentication"></a><a name="user-authentication"></a>Benutzer-Authentifizierung
...
## <a name="business-central-environments-discovery"></a><a name="business-central-environments-discovery"></a><a name="business-central-environments-discovery"></a>Erkennung von Business Central-Umgebungen
...
## <a name="application-service-connectivity"></a><a name="application-service-connectivity"></a><a name="application-service-connectivity"></a>Konnektivität der Anwendungsdienste
...
## <a name="web-server-connectivity"></a><a name="web-server-connectivity"></a><a name="web-server-connectivity"></a>Webserver-Konnektivität
...
## <a name="service-health-status"></a><a name="service-health-status"></a><a name="service-health-status"></a>Dienststatus
