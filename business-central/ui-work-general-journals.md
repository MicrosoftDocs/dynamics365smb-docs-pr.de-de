...
---
# <a name="work-with-general-journals" />Mit Fibu Buch.-Blättern arbeiten
...
## <a name="use-journal-templates-and-batches" />Buch-Blattvorlagen und -namen verwenden
...
### <a name="validating-general-journal-batches" />Fibu Buch.-Blatt-Stapelverarbeitungen überprüfen
...
## <a name="work-with-recurring-journals" />Mit wiederkehrenden Buchblättern arbeiten
...
### <a name="allocating-recurring-journal-amounts-to-several-accounts" />Zuordnung von Beträgen des wiederkehrenden Buch.-Blatts auf mehrere Konten
...
## <a name="work-with-standard-journals" />Mit Standard-Buchblättern arbeiten
...
### <a name="to-save-a-standard-journal" />Ein Standard-Buch.-Blatt speichern:
...
### <a name="to-reuse-a-standard-journal" />Standard-Protokolle wieder nutzen
...
## <a name="to-renumber-document-numbers-in-journals" />Belegnummern in Buch.-Blättern neu nummerieren
...
### <a name="to-renumber-documents-in-journals" />Belege in Buch.-Blättern neu nummerieren
