...
ms.author: edupont
---
# <a name="make-sales-quotes"></a><a name="make-sales-quotes"></a>Verkaufsangebote machen
...
## <a name="to-create-a-sales-quote"></a><a name="to-create-a-sales-quote"></a>So erstellen Sie Verkaufsangebote:
