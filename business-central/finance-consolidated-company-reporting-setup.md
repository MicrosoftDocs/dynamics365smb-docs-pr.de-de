...
### <a name="a-nameglaccaprepare-general-ledger-accounts-for-consolidation" /><a name="glacc"></a>Sachkonten für die Konsolidierung vorbereiten
...
### <a name="a-namedimainclude-or-exclude-dimensions" /><a name="dim"></a>Dimensionen ein- oder ausschließen
...
### <a name="a-nameexcludeaexclude-a-company-from-consolidation" /><a name="exclude"></a>Ein Unternehmen aus der Konsolidierung ausschließen
...
### <a name="a-nameincludeainclude-a-partially-owned-company-in-consolidation" /><a name="include"></a>Schließen Sie Unternehmen in die Konsolidierung ein, das teilweise im Besitz ist
