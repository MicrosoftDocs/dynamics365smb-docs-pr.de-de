...
Einige Bereiche erfordern, dass Sie ein Administrator Ihres Abonnement [!INCLUDE[prod_short](includes/prod_short.md)] sind. Weitere Informationen finden Sie unter [Verwaltung](admin-setup-and-administration.md).  
