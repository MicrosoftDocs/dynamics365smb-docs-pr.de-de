...
---
# <a name="error-message-posting-date-is-not-within-your-range-of-allowed-posting-dates" /><a name="error-message-posting-date-is-not-within-your-range-of-allowed-posting-dates"></a>Fehlermeldung: „Das Buchungsdatum liegt nicht in Ihrem Bereich der zulässigen Buchungsdaten...“
...
## <a name="change-the-user-setup" /><a name="change-the-user-setup"></a>Ändern Sie die Benutzereinrichtung
...
### <a name="overview-of-involved-posting-date-setup" /><a name="overview-of-involved-posting-date-setup"></a>Übersicht über die Einstellung des beteiligten Buchungsdatums

#### <a name="inventory-periods" /><a name="inventory-periods"></a>Lagerbuchungsperioden
...
#### <a name="general-ledger-setup" /><a name="general-ledger-setup"></a>Finanzbuchhaltung Einrichtung
...
#### <a name="user-setup" /><a name="user-setup"></a>Benutzereinrichtung
...
## <a name="see-also" /><a name="see-also"></a>Weitere Informationen
