...
Alle Zeilen, die nicht abgeglichen werden können (angezeigt durch einen Wert im Feld  **Differenz**), verbleiben nach der Buchung auf der Seite  **Bankkontoabgleich** . Sie stellen eine Art von Diskrepanz dar, die Sie beheben müssen, bevor Sie die Bankkontenabstimmung abschließen können. Die folgende Tabelle beschreibt einige typische Geschäftssituationen, die zu Unterschieden führen können.
...
* Wenn Sie Zahlungen auf der Seite  **Zahlungsabgleichsjournal**  abgleichen.
...
2. Geben Sie auf der Seite **Bankkto. Ausgl. Fibu Buch.-Bl.** an, welches Fibu Buch.-Blatt verwendet werden soll, und klicken Sie dann auf die Schaltfläche **OK** .
    ...
    Die Seite  **Allgemeine Journale**  wird mit neuen Journalzeilen für alle Bankauszugszeilen geöffnet, in denen Hauptbucheinträge fehlen.
...
Wenn Sie den Kontoauszugsbericht von der Seite  **Liste der Bankkontoauszüge**  aus ausführen, können Sie die Option  **Offene Posten**  aktivieren. Der Bericht enthält dann einen Abschnitt mit einer Liste offener Posten.
...
Wenn Sie einen Fehler in einer gebuchten Bankabstimmung feststellen, können Sie ihn mit der Aktion **Rückgängig machen** auf der Seite **Bankkonto Auszugsübersicht** korrigieren. Wenn Sie einen gebuchten Bankabgleich rückgängig machen, werden die Einträge auf die Seite  **Bankkontoabgleiche**  verschoben und als  **Offen** gekennzeichnet, was bedeutet, dass sie nicht abgestimmt sind. Sie können dann die Bankabstimmung korrigieren und erneut buchen.
...
[Abgleichen von Bankkonten](bank-manage-bank-accounts.md)    
[Bankkontoabstimmung mit der Unterstützung bei Bankkontoabstimmung (Vorschauversion)](bank-reconciliation-with-copilot.md)  
[Zahlungen automatisch anwenden und Bankkonten abgleichen](receivables-apply-payments-auto-reconcile-bank-accounts.md)    
[Einrichten des Bankgeschäfts](bank-setup-banking.md)    
