...
ms.author: edupont
---
# <a name="create-service-quotes"></a><a name="create-service-quotes"></a><a name="create-service-quotes"></a>Serviceangebote erstellen
...
## <a name="to-create-a-service-quote"></a><a name="to-create-a-service-quote"></a><a name="to-create-a-service-quote"></a>So erstellen Sie ein Serviceangebot
