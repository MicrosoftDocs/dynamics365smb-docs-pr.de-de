...
description: "Um Einnahmen und Ausgaben in Perioden außer der Periode zu erkennen, in der die Transaktion gebucht wird, können Sie Funktionen verwenden, um Einnahmen und Ausgaben über einen bestimmten Zeitplan automatisch abzugrenzen oder zurückzustellen."
...
Für beide Arten von Abgrenzungen wählen Sie im Feld **Art** **Bilanz** aus und benennen Sie die Konten entsprechend, wie "Nicht verdiente Erträge" für abgegrenzte Einnahmen und "nicht bezahlte Ausgaben" für abgegrenzte Ausgaben.
...
4. Geben Sie Feld **Berechnungsmethode** an, wie das Feld **Betrag** für jede Periode im Fenster **Abgrenzungsplan** berechnet wird. Sie haben die Wahl zwischen den folgenden Optionen:
   ...
   * **Benutzerdefiniert**: Die regelmäßig Abgrenzungsbeträge werden nicht berechnet. Sie müssen das Feld **Betrag** für jede Periode im Abgrenzungsplanfenster manuell ausfüllen. Weitere Informationen finden Sie im Abschnitt „So ändern Sie einen Abgrenzungszeitplan aus einer Verkaufsrechnung”.
...
## <a name="to-change-a-deferral-schedule-from-a-sales-invoice"></a>So ändern Sie einen Abgrenzungszeitplan von einer Verkaufsrechnung aus
> [!NOTE]  
...
4. Ändern Sie im Fenster **Abgrenzungszeitplan** die Einstellungen im Kopf oder die Werte in den Zeilen, zum Beispiel, um den Betrag bis zu einer zusätzlichen Buchhaltungsperiode abzugrenzen.
5. Wählen Sie die Aktion **Berechnungsplan** aus.
6. Wählen Sie die Schaltfläche **OK** aus. Der Abgrenzungszeitplan wird für die Verkaufsrechnung aktualisiert. Die zugehörige Abgrenzungsvorlage ist unverändert.
...
Zu einem bestimmten Abgrenzungskonto zu buchende Sachkonteneinträge, beispielsweise „Nicht verdiente Erträge”, werden von der Beschreibung bezeichnet, die Sie im Feld **Periodenbeschreibung** in der Abgrenzungsvorlage eingegeben haben, beispielsweise Einnahmenabgrenzung für Februar 2016.
