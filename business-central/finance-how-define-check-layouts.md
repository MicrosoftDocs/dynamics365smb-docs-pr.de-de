...
ms.author: edupont
---
# <a name="select-a-check-layout"></a><a name="select-a-check-layout"></a>Ein Prüflayout auswählen
...
## <a name="to-select-a-check-layout"></a><a name="to-select-a-check-layout"></a>Ein Prüflayout auswählen
