...
2. Ihre Sprache in  [!INCLUDE [prod_short.md](includes/prod_short.md)], die Sie im  [!INCLUDE [prod_short.md](includes/prod_short.md)] Webclient sehen können (mehr dazu unter  [Grundeinstellungen ändern – Sprache](ui-change-basic-settings.md#language)).
...
Eine Liste der unterstützten Sprachen erhalten Sie unter [!INCLUDE [prod_short.md](includes/prod_short.md)] unter [Unterstützte Sprachen](/dynamics365/business-central/dev-itpro/compliance/apptest-countries-and-translations?toc=/dynamics365/business-central/toc.json#supported-languages).

### Funktioniert die [!INCLUDE [prod_short.md](includes/prod_short.md)]-App mit Branchenlösungen?

Ja. Allerdings funktionieren nur einige Funktionen der App mit Embed-Apps:
...
Mobile Benutzer werden aufgefordert, sowohl die mobile App als auch die App zu installieren, damit Teams das Beste daraus [!INCLUDE [prod_short.md](includes/prod_short.md)] herausholen kann. Wenn beide installiert sind, können Sie die **Hervorhben** Aktion auf einer Karte in Teams auswählen, um die Kartendetails in der [!INCLUDE [prod_short.md](includes/prod_short.md)] App zu öffnen. Erfahren Sie mehr über die Installation der [!INCLUDE [prod_short.md](includes/prod_short.md)] und mobilen Teams-Apps in:
...
Weitere Informationen zu den Mindestanforderungen finden Sie unter  [Mindestanforderungen für die Verwendung von Business Central](product-requirements.md#teams).

Weitere Informationen zur Auswahl der Team-Clients und zu deren Installation finden Sie unter  [Clients abrufen für Microsoft Teams](/microsoftteams/get-clients)  in der Team-Dokumentation.
...
- Beim Verwenden von Microsoft Edge mit Teams im Browser können Sie problemlos über mehrere Identitäten und Konten hinweg arbeiten, indem Sie sich bei Teams aus verschiedenen Profilen anmelden. Weitere Informationen zur Verwendung von Profilen  Microsoft Edge unter  [Anmelden und Erstellen mehrerer Profile  Microsoft Edge](https://support.microsoft.com/office/sign-in-and-create-multiple-profiles-in-microsoft-edge-df94e622-2061-49ae-ad1d-6f0e43ce6435) im Microsoft-Support.
...
Sie können den empfohlenen Inhalten Listenseiten hinzufügen, indem Sie Lesezeichen hinzufügen. Sie können empfohlene Inhalte auch entfernen, indem Sie Lesezeichen löschen. Weitere Informationen finden Sie unter  [Seite oder Bericht in Ihrem Rollencenter als Lesezeichen speichern](ui-bookmarks.md).
...
### Wie kann ich aktuelle Dokumente für einen Debitor oder Kreditor anzeigen?
...
Ja. Die Suche nach Kontakten aus Teams basiert auf [!INCLUDE [prod_short.md](includes/prod_short.md)] v2.0-APIs und vorbehaltlich etwaiger API-Beschränkungen, die die Verwendung verwalten. Weitere Informationen zu den Beschränkungen finden Sie unter  [aktuelle API-Beschränkungen](/dynamics-nav/api-reference/v2.0/dynamics-current-limits).
...
### Kann ich Dokumente aus dem Detailfenster in Teams drucken?
...
### Kann ich Karten mit Benutzern außerhalb meiner Organisation teilen?
