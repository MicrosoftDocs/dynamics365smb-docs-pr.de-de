...
Nein. Die [!INCLUDE [prod_short.md](includes/prod_short.md)] App für Teams wird bei der Installation als Paket für MacOS oder Linux nicht unterstützt. Auf diesen Plattformen können Sie stattdessen über einen unterstützten Browser auf Teams zugreifen.
...
Nein. Das Erstellen von Registerkarten wirkt sich nicht auf die Berechtigungen aus, und Benutzer müssen bereits über die Berechtigung für diese Daten verfügen, wenn sie auf die Registerkarte zugreifen.
...
Nein. Die Business Central-App für Teams unterstützt keine Registerkarten in Besprechungen.
...
Nein. Nur Feldänderungen oder laufende Aktionen wirken sich darauf aus, wie andere den Inhalt der Registerkarte sehen.
...
Nein. Jeder Benutzer zeigt die Registerkarteninhalte in den Sprach-, Regions- und Zeitzoneneinstellungen von Business Central an. 
...
Nein. Kontakte gespeichert in [!INCLUDE [prod_short.md](includes/prod_short.md)] bleiben getrennt von Ihren in Teams gespeicherten Kontakten.
...
Nein. Die Feldwerte auf einer Karte in Teams, einschließlich aller Bilder, basieren auf den Daten, die verfügbar waren, als diese Karte an den Chat gesendet wurde. [!INCLUDE [prod_short.md](includes/prod_short.md)] Karten werden in Teams nicht automatisch aktualisiert. 
...
Nein. Während jeder im Chat oder Meeting die Karte selbst anzeigen kann, wird das Detailfenster nur dann auf Ihrem Gerät angezeigt, wenn Sie **Einzelheiten** auswählen. Andere Benutzer müssen wählen **Einzelheiten** auswählen, wenn sie das Detailfenster auf ihrem Gerät anzeigen möchten.
