...
## <a name="to-finish-a-physical-inventory-recording" />So schließen Sie eine Inventurerfassung ab
...
## <a name="to-complete-a-physical-inventory-order" />So schließen Sie einen Inventurauftrag ab
...
## <a name="handling-item-tracking-when-counting-inventory" />Verarbeitung der Artikelverfolgung beim Erfassen des Lagerbestands
