...
### <a name="to-fill-in-intrastat-journals" />Intrastat-Buch.-Blätter ausfüllen:
...
### <a name="to-modify-intrastat-journals-lines" />So ändern Sie die Zeilen der Intrastat-Erfassungen
...
## <a name="reorganize-intrastat-journals" />Reorganisieren von Intrastat Buch.-Blättern
