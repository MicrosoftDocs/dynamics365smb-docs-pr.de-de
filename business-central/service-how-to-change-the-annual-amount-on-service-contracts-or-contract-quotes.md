...
ms.author: bholtorf
---
# <a name="change-the-annual-amount-on-service-contracts-or-contract-quotes"></a><a name="change-the-annual-amount-on-service-contracts-or-contract-quotes"></a>Ändern des jährlichen Betrags für Serviceverträgen oder Vertragsangebote
...
## <a name="to-change-the-annual-amount-of-the-service-contract-or-contract-quote"></a><a name="to-change-the-annual-amount-of-the-service-contract-or-contract-quote"></a>So ändern Sie den Betrag "Zu fakturieren (Jahr)" eines Servicevertrags oder Vertragsangebots
...
### <a name="even-distribution"></a><a name="even-distribution"></a>Gleichmäßige Verteilung
...
### <a name="distribution-based-on-line-amount"></a><a name="distribution-based-on-line-amount"></a>Verteilung nach Zeilenbetrag
...
### <a name="distribution-based-on-profit"></a><a name="distribution-based-on-profit"></a>Verteilung nach DB
