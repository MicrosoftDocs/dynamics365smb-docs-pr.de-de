...
ms.author: bholtorf
---
# <a name="change-the-annual-amount-on-service-contracts-or-contract-quotes" />Ändern des jährlichen Betrags für Serviceverträgen oder Vertragsangebote
...
## <a name="to-change-the-annual-amount-of-the-service-contract-or-contract-quote" />So ändern Sie den Betrag "Zu fakturieren (Jahr)" eines Servicevertrags oder Vertragsangebots
...
### <a name="even-distribution" />Gleichmäßige Verteilung
...
### <a name="distribution-based-on-line-amount" />Verteilung nach Zeilenbetrag
...
### <a name="distribution-based-on-profit" />Verteilung nach DB
