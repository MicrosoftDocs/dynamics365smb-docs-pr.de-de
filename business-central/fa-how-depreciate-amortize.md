...
1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet.](media/ui-search/search_small.png "Sagen Sie mir, was Sie tun möchten") Symbol. Geben Sie **AfA berechnen** ein, und wählen Sie dann den entsprechenden Link.  
...
1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet.](media/ui-search/search_small.png "Sagen Sie mir, was Sie tun möchten") Symbol. Geben Sie **Anlagen-Fibu Buch.-Blatt** ein und wählen Sie dann den entsprechenden Link.  
...
3. Füllen Sie für jede Buchungsgruppe die Sachkonten und die entsprechenden Zuteilungsprozentsätze aus, und schließen Sie anschließend die Seite.
4. Wählen Sie als Nächstes die ![Glühbirne, die die „Wie möchten Sie weiter verfahren-Funktion öffnet.](media/ui-search/search_small.png "Was möchten Sie tun?") aus, geben Sie **Anlagen-Fibu Buch.-Blätter** ein, und wählen Sie dann den zugehörigen Link aus.
5. Geben Sie die Anlage und die entsprechende Anlagenbuchungsgruppe ein, und das Afa-Buch bestimmen die Zuteilungspositionen.
6. Wählen Sie die Aktion **Buchen**, um das Journal zu buchen.

> [!NOTE]  
> Wenn eine Anlage von mehreren Abteilungen verwendet wird, können Sie die Dimension in der Anlagen-Fibu Buch.-Blattzeile auswählen.
...
5. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren-Funktion öffnet.](media/ui-search/search_small.png "Was möchten Sie tun?") Symbol. Geben Sie **FA-Erfassungen Buch.-Blätter** ein und wählen Sie dann den zugehörigen Link.  
...
Sie können mit Hilfe der Stapelverarbeitung **AfA-Buch kopieren** Posten von einem AfA-Buch in ein anderes AfA-Buch kopieren. Die Stapelverarbeitung erstellt Buch.-Blattzeilen in dem Buch.-Blatt, das Sie auf der Seite **Anlagen Buch.-Blatt Einr.** für das AfA-Buch angegeben haben, aus dem Sie kopieren möchten. Weitere Informationen finden Sie unter [So kopieren Sie Anlagenposten zwischen Afa-Büchern](#to-copy-fixed-asset-ledger-entries-between-depreciation-books).  
