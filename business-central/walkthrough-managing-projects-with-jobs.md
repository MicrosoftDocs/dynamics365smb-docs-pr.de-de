...
### <a name="to-create-a-project-journal-batch"></a>So erstellen Sie einen Projekt Buch.-Blattnamen
...
### <a name="to-enter-hours-in-a-project-journal"></a>So erfassen Sie Stunden im Projektbuchhaltungsblatt
