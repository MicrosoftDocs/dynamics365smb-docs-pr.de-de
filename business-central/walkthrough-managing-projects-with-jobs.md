...
### <a name="to-create-a-job-journal-batch" />So erstellen Sie einen Projekt Buch.-Blattnamen
...
### <a name="to-enter-hours-in-the-job-journal" />So erfassen Sie Stunden im Projektbuchhaltungsblatt
