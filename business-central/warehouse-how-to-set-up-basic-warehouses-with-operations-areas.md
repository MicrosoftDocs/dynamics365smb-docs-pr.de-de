...
ms.author: edupont
---
# <a name="set-up-basic-warehouses-with-operations-areas" />Basislager mit Vorgängen festlegen
...
## <a name="to-define-a-default-bin-structure-in-the-production-area" />Um eine Standardlagerplatzstruktur im Fertigungsbereich zu definieren
...
## <a name="to-define-a-default-bin-structure-in-the-assembly-area" />Um eine Standardlagerplatzstruktur im Montagebereich zu definieren
...
### <a name="to-set-up-the-bin-in-the-assembly-area-where-components-are-placed-by-default-before-they-can-be-consumed-in-assembly" />Um den Lagerplatz im Montagebereich einzurichten, wo Komponenten standardmäßig platziert werden, bevor sie bei der Montage verbraucht werden können.
...
### <a name="to-set-up-the-bin-in-the-assembly-area-where-finished-assembly-items-are-posted-to-when-they-are-assembled-to-stock" />Um den Lagerplatz im Montagebereich einzurichten, auf den fertige Montageartikel gebucht werden, wenn sie im Lager montiert werden.
