...
ms.author: edupont
---
# <a name="quote-an-assemble-to-order-sale"></a><a name="quote-an-assemble-to-order-sale"></a><a name="quote-an-assemble-to-order-sale"></a>Angebot eines Auftragsmontageverkaufs
...
## <a name="to-create-a-sales-quote-for-an-assemble-to-order-item"></a><a name="to-create-a-sales-quote-for-an-assemble-to-order-item"></a><a name="to-create-a-sales-quote-for-an-assemble-to-order-item"></a>So erstellen Sie ein Verkaufsangebot für einen Auftragsmontageartikel:
