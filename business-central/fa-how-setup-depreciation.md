...
# <a name="set-up-fixed-asset-depreciation"></a><a name="set-up-fixed-asset-depreciation"></a>Richten Sie eine neue Anlagenkarte ein
...
## <a name="to-create-a-depreciation-book"></a><a name="to-create-a-depreciation-book"></a>So erstellen Sie ein Anlagen-AfA-Buch
...
## <a name="to-assign-a-depreciation-book-to-a-fixed-asset"></a><a name="to-assign-a-depreciation-book-to-a-fixed-asset"></a>So verknüpfen Sie ein AfA-Buchs mit einer Anlage
...
## <a name="to-assign-a-depreciation-book-to-multiple-fixed-assets-with-a-batch-job"></a><a name="to-assign-a-depreciation-book-to-multiple-fixed-assets-with-a-batch-job"></a>So weisen Sie ein AfA-Buch mehreren Anlagen mit einer Stapelverarbeitung zu
...
## <a name="to-set-up-depreciation-posting-types"></a><a name="to-set-up-depreciation-posting-types"></a>So richten Sie AfA-Buchungsarten ein:
...
## <a name="to-set-up-default-templates-and-batches-for-fixed-asset-depreciation"></a><a name="to-set-up-default-templates-and-batches-for-fixed-asset-depreciation"></a>So richten Sie Standardvorlagen und -Standardstapelverarbeitungen für Anlagen-AfA ein
