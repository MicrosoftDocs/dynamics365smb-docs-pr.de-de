...
Wenn Sie **Verarbeiten** in [!INCLUDE[d365fin](includes/d365fin_md.md)] für ein Angebot wählen, das den Status **Gewonnen** hat, wird ein Verkaufsauftrag in [!INCLUDE[d365fin](includes/d365fin_md.md)] nur dann erstellt, wenn ein entsprechender Verkaufsauftrag in [!INCLUDE[crm_md](includes/crm_md.md)] eingereicht wird. Andernfalls wird das Angebot nur in [!INCLUDE[d365fin](includes/d365fin_md.md)] freigegeben. Wenn ein entsprechender Verkaufsauftrag später in [!INCLUDE[crm_md](includes/crm_md.md)] eingereicht wird und ein Verkaufsauftrag auf dessen Grundlage erstellt wird, wird die **Angebotsnummer** im Verkaufsauftrag aktualisiert und das Angebot wird archiviert.
