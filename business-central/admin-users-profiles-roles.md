...
Bevor Sie Benutzerprofile verwalten können, müssen Sie die Benutzer erstellen und über das Microsoft 365 Admin Center hinzufügen. Anschließend können Sie jedem Benutzer oder jeder Benutzergruppe Berechtigungen zuweisen. Berechtigungen definieren die Funktionen, auf die Benutzer zugreifen können. Weitere Informationen finden Sie unter [Berechtigungen an Benutzer und Gruppen zuweisen](ui-define-granular-permissions.md).
...
*-* Sie können jeweils nur ein Profil zur Zeit löschen.
