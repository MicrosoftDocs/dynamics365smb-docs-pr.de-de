...
## <a name="item-reclassification-journals" />Buch.-Blätter für die Neuklassifizierung von Artikeln
...
### <a name="schedule-a-job-queue-entry-to-post-multiple-documents-in-a-batch" />Planen Sie einen Auftragswarteschlangeneintrag, um mehrere Dokumente in einem Stapel zu veröffentlichen
...
## <a name="to-transfer-items-with-the-item-reclassification-journal" />So lagern Sie Artikel mit dem Artikel Umlag. Buch.-Blatt um
