...
## <a name="item-reclassification-journals"></a><a name="item-reclassification-journals"></a>Buch.-Blätter für die Neuklassifizierung von Artikeln
...
### <a name="schedule-a-job-queue-entry-to-post-multiple-documents-in-a-batch"></a><a name="schedule-a-job-queue-entry-to-post-multiple-documents-in-a-batch"></a>Planen Sie einen Auftragswarteschlangeneintrag, um mehrere Dokumente in einem Stapel zu veröffentlichen
...
## <a name="to-transfer-items-with-the-item-reclassification-journal"></a><a name="to-transfer-items-with-the-item-reclassification-journal"></a>So lagern Sie Artikel mit dem Artikel Umlag. Buch.-Blatt um
