...
ms.author: edupont
---
# <a name="create-incoming-document-records-directly-from-documents-and-entries" />Erstellen und Verknüpfen von eingehenden Belegen aus Dokumenten und Posten
...
## <a name="remove-a-connection-from-an-incoming-document-record-to-a-posted-document" />So entfernen Sie die Verknüpfung des eingehenden Beleges zu einem gebuchten Beleg
