...
ms.author: edupont
---
# <a name="add-extended-text"></a><a name="add-extended-text"></a>Textbaustein hinzufügen
...
## <a name="to-define-extended-text-for-an-description"></a><a name="to-define-extended-text-for-an-description"></a>So definieren Sie Textbausteine für eine Beschreibung
