---
title: Cashflow-Analyse einrichten
...
Um Sie zu unterstützen, stellt [!INCLUDE [prod_short](includes/prod_short.md)] einige Konten und Cashfloweinrichtungen bereit. Sie können diese ändern, hinzufügen oder entfernen.  
...
* Ob [Azure AI](https://azure.microsoft.com/overview/ai-platform/) aktiviert werden soll.  
...
1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren-Funktion öffnet.](media/ui-search/search_small.png "Wie möchten Sie weiter verfahren") Symbol. Geben Sie **Cashflow-Einrichtung** ein und wählen Sie dann den zugehörigen Link.  
