...
ms.author: bholtorf
---
# <a name="set-up-invoice-rounding" />Rundung von Rechnungen festlegen
...
## <a name="set-up-general-ledger-accounts-for-invoice-rounding-differences" />Sachkonten für Rechnungsrundungsdifferenzen einrichten
...
### <a name="to-set-up-general-ledger-accounts-for-invoice-rounding-differences" />Sachkonten für Rechnungsrundungsdifferenzen einrichten:
