...
### <a name="to-specify-general-ledger-accounts-for-posting-exchange-rate-adjustments" />Sachkonten für die Buchung von Kursregulierungen festlegen:
...
### <a name="to-specify-the-exchange-rate-adjustment-method-for-all-general-ledger-accounts" />So geben Sie die Kursregulierungsmethode für alle Sachkonten an
