...
|Verkaufsrechnungen|Keine Optionen| Die Buchungen ist gemäß Benutzereinrichtung unzulässig.|Möchten Sie die Rechnung buchen?|
|Verkaufsgutschrift|Keine Optionen|Die Buchungen ist gemäß Benutzereinrichtung unzulässig.|Möchten Sie die Gutschrift buchen?|
...
|Einkaufsrechnung|Keine Optionen|Die Buchungen ist gemäß Benutzereinrichtung unzulässig.|Möchten Sie die Rechnung buchen?|
|Einkaufsgutschrift|Keine Optionen|Die Buchungen ist gemäß Benutzereinrichtung unzulässig.|Möchten Sie die Gutschrift buchen?|
