...
- Benutzern muss eine Microsoft 365-Lizenz aus einem der folgenden Pläne zugewiesen werden.
  ...
  |Microsoft Teams EWR|7e74bd05-2c47-404e-829a-ba95c66fe8e5|
...
- Machen Sie sich mit dem Benutzerzugriffsflow vertraut, um Ihren Ansatz und Ihre Konfiguration von Business Central so zu planen, dass sie den Geschäftsanforderungen entsprechen. Weitere Informationen finden Sie im  [Benutzerzugriffsablauf](admin-access-with-m365-license-flow.md).
- Richten Sie Ihre Umgebung und Benutzer für den Zugriff mit Microsoft 365-Lizenzen ein. Weitere Informationen finden Sie unter  [Zugriff mit  Microsoft 365 Lizenzen einrichten](admin-access-with-m365-license-setup.md).
- Tipps zur Fehlerbehebung finden Sie unter  [Fehlerbehebung in Business Central](/troubleshoot/dynamics-365/business-central/welcome-business-central).
