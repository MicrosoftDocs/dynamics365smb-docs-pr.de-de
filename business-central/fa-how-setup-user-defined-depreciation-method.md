...
## <a name="to-set-up-user-defined-depreciation-methods" />So richten Sie benutzerdefinierte AfA-Methoden ein
...
### <a name="example---user-defined-depreciation" />Beispiel - Benutzerdefinierte AfA
