...
### <a name="including-or-excluding-vat-in-prices-and-line-amounts" />Einschließlich oder ohne Mehrwertsteuer in Preisen und Zeilenbeträgen
...
### <a name="vat-date-in-documents" />Umsatzsteuerdatum in Dokumenten
...
## <a name="calculating-vat-manually-using-journals" />MwSt.-Berechnung mithilfe von Buch.-Blättern manuell berechnen
...
### <a name="to-set-the-system-up-for-manual-vat-entry-in-a-general-journals" />Einrichtung des Systems für die manuelle MwSt.-Posten im Fibu Buch.-Blatt
...
### <a name="to-set-the-system-up-for-manual-vat-entry-in-a-sales-and-purchase-journals" />Einrichtung des Systems für die manuellen MwSt.-Posten in einem Verkaufs- und Einkaufs-Buch.-Blatt
