...
ms.author: edupont
---
# <a name="transferring-and-posting-cost-entries" />Übertragen und Buchen von Kalkulationen
...
## <a name="criteria-for-transferring-general-ledger-entries-to-cost-entries" />Kriterien für die Übertragung von Sachposten in Kostenposten
...
## <a name="transferring-general-ledger-entries-to-cost-entries" />Übertragung von Sachposten in Kostenposten
...
### <a name="to-transfer-general-ledger-entries-to-cost-entries" />So übertragen Sie Sachposten in Kostenposten
...
## <a name="results-of-transferring-general-ledger-entries-to-cost-entries" />Kriterien für die Übertragung von Sachposten in Kostenposten
