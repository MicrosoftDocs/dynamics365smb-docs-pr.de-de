...
## <a name="to-set-up-the-payment-registration-journal"></a><a name="to-set-up-the-payment-registration-journal"></a><a name="to-set-up-the-payment-registration-journal"></a>Zahlungsregistrierungsbuch.-Blatt einrichten
