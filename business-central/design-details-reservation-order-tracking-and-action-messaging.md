...
description: Das Reservierungssystem ist umfassend und umfasst die miteinander verbundenen und parallelen Funktionen der Auftragsverfolgung und Aktionsnachrichten.
author: brentholtorf
ms.topic: conceptual
ms.devlang: al
...
1. Prüfung auf geplante und zeitlich geplante Zugänge in der Reihenfolge des Eingangsdatums. Das letzte mögliche Datum ist ausgewählt.  
1. Prüfung auf verfügbaren Lagerbestand.  
1. Prüfung, ob ein Beschaffungsauftrag im aktuellen Auftragsnachverfolgungsdatensatz vorhanden ist. Wenn dies der Fall ist, gibt das System eine Aktionsnachricht vom Typ  *Ändern*  aus, um die Bestellung zu erhöhen.  
1. Prüfung, ob kein Beschaffungsauftrag im aktuellen Auftragsnachverfolgungsdatensatz vorhanden ist. Wenn dies der Fall ist, gibt das System eine Aktionsnachricht vom Typ  *Neu*  aus, um eine neue Bestellung zu erstellen.  
