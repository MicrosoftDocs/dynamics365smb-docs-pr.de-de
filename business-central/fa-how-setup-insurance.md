...
## <a name="to-set-up-insurance-journal-templates" />So richten Sie Versicherungs Buch.-Blattvorlagen ein
...
## <a name="to-set-up-insurance-journal-batches" />So richten Sie Versicherungs Buch.-Blattnamen ein
