...
Um Attribute und Mengen im Artikelposten zu ändern, verwenden Sie ein Artikel Umlag. Buch.-Blatt. Zu den typischen neu zu klassifizierenden Attributen gehören Dimensionen und Verkaufskampagnencodes. Sie können Neuklassifizierungserfassungen auch für Umbuchungen verwenden, indem Lagerplatz- und Lagerplatzcodes neu klassifiziert werden. Spezielle Schritte treffen zu, wenn Sie Serien- oder Chargennummern und deren Ablaufdatum umbuchen möchten. Weitere Informationen finden Sie unter [Arbeiten mit Serien- und Chargennummern](inventory-how-work-item-tracking.md).
...
2. Um die berechneten Mengen mit den tatsächlich gezählten Mengen zu vergleichen, wählen Sie die Aktion  **Buchen** auf der  **Startseite**.
    ...
    Die Buchung erstellt Artikelposten als auch Inventurposten. Öffnen Sie die Seite Artikelkarte für den Artikel, um die Inventurposten zu finden.
...
1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren-Funktion öffnet.](media/ui-search/search_small.png "Sagen Sie mir, was Sie tun möchten") Geben Sie **Logistik Inventur Buch.-Blatt** ein und wählen Sie den zugehörigen Link.  
...
3. Legen Sie Filter fest, um die Artikel anzugeben, die im Buch.-Blatt gezählt werden sollen, und wählen Sie **OK**.
   ...
   Wenn Sie nur ein Artikel in einigen Lagerplätzen zu zählen, aber nicht an anderen, können Sie Differenzen eingeben und sie später mit der Aktion **Ausgleich berechnen** auf der Seite **Artikel Buch.-Blatt** buchen.  
...
4. Füllen Sie im Inforegister **Optionen** das Feld **Belegnr.** mit einer Nummer aus. Die Nummer wird in der Buch.-Blattzeile angezeigt.
...
6. Buchen Sie die Buch.-Blattzeilen, um die Mengenabweichungen als Artikelposten zu buchen. Die Mengen an den Lagerplätzen und im Artikelbuch stimmen jetzt überein.  
