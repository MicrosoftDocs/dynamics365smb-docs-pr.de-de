...
---
# <a name="cross-dock-items"></a><a name="cross-dock-items"></a>Zuordnungselemente
...
## <a name="cross-dock-bins-and-zones"></a><a name="cross-dock-bins-and-zones"></a>Zuordnungslagerplätze und-zonen
...
## <a name="cross-dock-select-lines-for-a-receipt"></a><a name="cross-dock-select-lines-for-a-receipt"></a>Zuordnungsauswahlpositionen für einen Eingang
...
## <a name="to-set-up-the-warehouse-for-cross-docking"></a><a name="to-set-up-the-warehouse-for-cross-docking"></a>So richten Sie die Logistik für Zuordnungen ein:
