...
1. Wenn Sie Lagerplätze verwenden, richten Sie mindestens einen Zuordnungslagerplatz ein. Wenn Sie die gesteuerte Einlagerung und Kommissionierung verwenden, richten SIe eine Zuordnungszone ein.  
    ...
    Für einen Zuordnungslagerplatz ist das Feld **Zuordnungslagerplatz** ausgewählt. Weitere Informationen zu Lagerplätzen finden Sie unter [Lagerplätze erstellen](warehouse-how-to-create-individual-bins.md).  

    Wenn Sie Zonen verwenden, erstellen Sie eine Zone für Ihre Zuordnungslagerplätze, und wählen Sie das Feld **Zuordnungslagerplatzzone** aus. Wenn Sie die gezielte Einlagerung und Kommissionierung verwenden, wählen Sie den Lagerplatztyp mit der Option **Kommissionierung** aus. Beispielsweise können Sie *KOMMISSIONIERUNG* oder *EINLAGKOMM* verwenden. Weitere Informationen zu Zonen und Lagerplatztypen finden Sie unter [Lagerorte für die Verwendung von Lagerplätzen einrichten](warehouse-how-to-set-up-locations-to-use-bins.md) und [Lagerplatztypen einrichten](warehouse-how-to-set-up-bin-types.md).  

2. Wählen Sie das Symbol ![Glühbirne, die die „Sie wünschen ...“-Funktion öffnet](media/ui-search/search_small.png "Wie möchten Sie weiter verfahren?") Symbol. Geben Sie **Lagerort** ein und wählen Sie dann den zugehörigen Link.  
