...
---
# <a name="cross-dock-items" />Zuordnungselemente
...
## <a name="cross-dock-bins-and-zones" />Zuordnungslagerplätze und-zonen
...
## <a name="cross-dock-select-lines-for-a-receipt" />Zuordnungsauswahlpositionen für einen Eingang
...
## <a name="to-set-up-the-warehouse-for-cross-docking" />So richten Sie die Logistik für Zuordnungen ein:
