...
## <a name="preview-a-report"></a>Einen Bericht anzeigen
...
## <a name="schedule-a-report-to-run-later-or-periodically"></a><a name="ScheduleReport"></a>Planen der späteren oder regelmäßigen Ausführung eines Berichts
