...
## <a name="schedule-a-report-to-run-later-or-periodically"></a><a name="ScheduleReport"></a>Die spätere oder regelmäßige Ausführung eines Berichts planen
...
1. Wählen Sie das ![Glühbirne, welche die 1. „Sie wünschen ...“-Funktion öffnet.](media/ui-search/search_small.png "Wie möchten Sie weiter verfahren?") Symbol. Geben Sie **Auftragswarteschlangenposten** ein und wählen Sie dann den zugehörigen Link aus.  
...
> [!TIP]
> Der Drucker, der standardmäßig für Sie ausgewählt wurde, ist auf der Seite **Druckerauswahl** eingerichtet. Erfahren Sie im Abschnitt [Standarddrucker einrichten](ui-specify-printer-selection-reports.md#default) mehr darüber, wie Sie den Standarddrucker ändern können.
