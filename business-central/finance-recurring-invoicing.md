...
## <a name="create-multiple-invoices-based-on-a-recurring-project-journal"></a>Erstellen mehrerer Rechnungen basierend auf einem wiederkehrenden Projekt-Buch.-Blatt
