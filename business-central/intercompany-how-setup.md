...
## <a name="set-up-intercompany-general-journal-templates-and-batches" />So richten Sie allgemeine Intercomapny-FibuBuch.-Blattzeilenvorlagen und -chargen ein
...
### <a name="set-up-default-intercompany-partner-general-ledger-accounts" />Vorgegebene IC-Partner-Sachkonten einrichten
