...
Der Teil **Meine Aufgabenwarteschlange** in Ihrem Rollencenter zeigt die Aufgabenwarteschlangeneinträge an, die Sie gestartet haben, die jedoch nicht abgeschlossen sind. Dieser Teil wird standardmäßig nicht angezeigt, Sie können ihn jedoch Ihrem Rollencenter hinzufügen. Weitere Informationen zur Personalisierung finden Sie unter [Ihren Arbeitsbereich personalisieren](ui-personalization-user.md).  
