...
- Er hat keinerlei Auswirkungen auf die Planung von Aufträgen. Die Planung (MPS und MRP) berücksichtigt keine simulierten Produktionsaufträge und wird auch nicht davon beeinflusst. Außerdem kann ein simulierter Fertigungsauftrag nicht als Vorlage verwendet werden, weil er gelöscht wird, sobald Sie seinen Status geändert haben.  
