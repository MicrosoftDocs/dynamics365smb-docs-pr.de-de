...
Administratoren und Endbenutzer haben das Steuerelement für die in OneDrive gespeicherten Inhalte, und diese Daten sind das alleinige Eigentum Ihrer Organisation. Weitere Informationen finden Sie unter [Wie SharePoint und OneDrive Ihre Daten in der Cloud schützen](/sharepoint/safeguarding-your-data). Besuchen Sie auch unsere [Microsoft-Datenschutzbestimmungen](https://go.microsoft.com/fwlink/?LinkId=521839)<!--(https://privacy.microsoft.com/en-us/privacystatement)-->, in der erläutert wird, welche Daten Microsoft verarbeitet, wie Microsoft sie verarbeitet und zu welchen Zwecken.
