...
### <a name="to-set-the-payment-journal-up-to-export-payment-files" />Das Zahlungsausgangs Buch.-Blatt für den Export von Zahlungsdateien festlegen
...
## <a name="preparing-the-payment-journal" />Zahlungsausgangs Buch.-Blatt vorbereiten.
