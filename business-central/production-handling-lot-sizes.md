...
# <a name="handling-lot-sizes-in-production"></a><a name="handling-lot-sizes-in-production"></a>Umgang mit Losgrößen in der Produktion
...
## <a name="lot-size-on-routing-lines"></a><a name="lot-size-on-routing-lines"></a>Losgröße auf Arbeitsgänge
...
## <a name="lot-sizes-for-items-and-stockkeeping-units"></a><a name="lot-sizes-for-items-and-stockkeeping-units"></a>Losgrößen für Artikel und Lagereinheiten
...
## <a name="lot-size-on-item-and-stockkeeping-units"></a><a name="lot-size-on-item-and-stockkeeping-units"></a>Losgröße für Artikel und Lagereinheiten
