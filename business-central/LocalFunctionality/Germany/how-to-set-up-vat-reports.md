...
ms.author: edupont
---
# <a name="set-up-vat-reports-in-the-german-version"></a><a name="set-up-vat-reports-in-the-german-version"></a>Festlegen von MwSt.-Berichten in der deutschen Version
...
## <a name="to-set-up-a-vat-report"></a><a name="to-set-up-a-vat-report"></a>So richten Sie einen MwSt-Bericht ein
