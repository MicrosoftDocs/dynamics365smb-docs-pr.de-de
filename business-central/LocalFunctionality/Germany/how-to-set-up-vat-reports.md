...
ms.author: edupont
---
# <a name="set-up-vat-reports-in-the-german-version" />Festlegen von MwSt.-Berichten in der deutschen Version
...
## <a name="to-set-up-a-vat-report" />So richten Sie einen MwSt-Bericht ein
