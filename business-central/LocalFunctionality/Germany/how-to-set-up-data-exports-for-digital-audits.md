...
ms.author: edupont
---
# <a name="set-up-data-exports-for-a-digital-audit-gobdgdpdu-in-the-german-version" />Datenexporte für eine digitale Betriebsprüfung (GoBD/GDPdU) in der deutschen Version festlegen
...
## <a name="to-set-up-a-data-export" />So richten Sie einen GDPdU-Datenexport ein
...
## <a name="to-add-a-record-definition-to-a-digital-audit-definition-group" />Wählen Sie eine Datensatzdefinition aus, die Sie einer GDPdU-Definitionsgruppe hinzufügen möchten.
...
## <a name="to-add-source-tables-to-a-data-export" />So fügen Sie einem Datenexport Quelltabellen hinzu
...
## <a name="to-add-related-tables-to-a-data-export-source" />So fügen Sie eine verwandte Tabelle einer Datenexportquelle hinzu
