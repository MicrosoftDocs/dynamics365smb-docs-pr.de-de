...
ms.author: edupont
---
# <a name="create-vat-reports-in-the-german-version"></a><a name="create-vat-reports-in-the-german-version"></a><a name="create-vat-reports-in-the-german-version"></a>Erstellen von MwSt.-Berichten in der deutschen Version
...
## <a name="to-create-a-vat-report"></a><a name="to-create-a-vat-report"></a><a name="to-create-a-vat-report"></a>Einen MwSt.-Bericht erstellen:
...
## <a name="to-submit-a-vat-report"></a><a name="to-submit-a-vat-report"></a><a name="to-submit-a-vat-report"></a>Einen MwSt.-Bericht übermitteln:
