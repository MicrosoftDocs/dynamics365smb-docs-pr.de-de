...
ms.author: bholtorf
---
# <a name="set-up-reports-for-vat-and-intrastat"></a><a name="set-up-reports-for-vat-and-intrastat"></a><a name="set-up-reports-for-vat-and-intrastat"></a>Richten Sie Berichte für MwSt ein.
...
## <a name="to-set-up-reports-for-vat"></a><a name="to-set-up-reports-for-vat"></a><a name="to-set-up-reports-for-vat"></a>Richten Sie MwSt.-Berichte ein.
...
### <a name="to-set-up-reports-for-intrastat"></a><a name="to-set-up-reports-for-intrastat"></a><a name="to-set-up-reports-for-intrastat"></a>Richten Sie Intrastat-Berichte ein.
