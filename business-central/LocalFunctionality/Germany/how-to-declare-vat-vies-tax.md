...
ms.author: edupont
---
# <a name="declare-vat-vies-tax-in-the-german-version" />MwSt-VIES-Steuererklärung in der deutschen Version
...
## <a name="to-declare-vat-vies-tax" />So erstellen Sie eine zusammenfassende Meldung
