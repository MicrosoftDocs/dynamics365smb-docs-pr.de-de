...
ms.author: edupont
---
# <a name="gdpdu-filter-examples-in-the-german-version"></a><a name="gdpdu-filter-examples-in-the-german-version"></a>GDPdU-Filter-Beispiele in der deutschen Version
...
## <a name="setting-up-export-record-source-examples"></a><a name="setting-up-export-record-source-examples"></a>Einrichten von Beispielen für Datensatzquellen für den Export

### <a name="period-field-no"></a><a name="period-field-no"></a>Periodenfeldnr.
...
### <a name="table-filter"></a><a name="table-filter"></a>Tabellenfilter
...
### <a name="date-filter-field-no-and-date-filter-handling"></a><a name="date-filter-field-no-and-date-filter-handling"></a>Datumsfilter-Feldnummer und Behandlung von Datumsfiltern
...
### <a name="date-filter-handling-for-the-same-table"></a><a name="date-filter-handling-for-the-same-table"></a>Datumsfilterbehandlung für dieselbe Tabelle
