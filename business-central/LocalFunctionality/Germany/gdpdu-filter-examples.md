...
ms.author: edupont
---
# <a name="gdpdu-filter-examples-in-the-german-version" />GDPdU-Filter-Beispiele in der deutschen Version
...
## <a name="setting-up-export-record-source-examples" />Einrichten von Beispielen für Datensatzquellen für den Export

### <a name="period-field-no" />Periodenfeldnr.
...
### <a name="table-filter" />Tabellenfilter
...
### <a name="date-filter-field-no-and-date-filter-handling" />Datumsfilter-Feldnummer und Behandlung von Datumsfiltern
...
### <a name="date-filter-handling-for-the-same-table" />Datumsfilterbehandlung für dieselbe Tabelle
