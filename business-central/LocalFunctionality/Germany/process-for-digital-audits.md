...
ms.author: edupont
---
# <a name="process-for-digital-audits-gobdgdpdu"></a><a name="process-for-digital-audits-gobdgdpdu"></a>Prozess für Digital-Überwachung (/GoBD GDPdU)
...
## <a name="defining-gdpdu-export-data"></a><a name="defining-gdpdu-export-data"></a>Gewusst wie: Exportieren von GDPdU-Daten
...
### <a name="data-export-filters"></a><a name="data-export-filters"></a>Datenexportfilter
...
## <a name="export-performance"></a><a name="export-performance"></a>Export-Leistung
