...
5. Teilen Sie die Drucker mit Benutzern.
    ...
    > [!TIP]
    > Sie können Benutzer später jederzeit hinzufügen oder entfernen. Weitere Informationen finden Sie unter  [Benutzerberechtigungen für Drucker konfigurieren Teilen](/universal-print/reference/portal/share-printers#configure-user-permissions-for-a-printer-share).
...
6. Aktivieren Sie die Dokumentkonvertierung.
    ...
    Weitere Informationen finden Sie unter  [Übersicht zur Dokumentkonvertierung](/universal-print/reference/portal/settings#2-document-conversion).
