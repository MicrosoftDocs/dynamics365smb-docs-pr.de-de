...
### <a name="can-i-build-a-power-bi-report-using-the-sales-invoice-lines-or-journal-lines-apis"></a><a name="can-i-build-a-power-bi-report-using-the-sales-invoice-lines-or-journal-lines-apis"></a>Kann ich einen Power BI-Bericht mit den APIs für Verkaufsrechnungen oder Buchungsblattzeilen erstellen?
