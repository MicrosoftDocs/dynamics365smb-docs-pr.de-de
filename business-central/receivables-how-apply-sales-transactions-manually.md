...
ms.author: edupont
---
# <a name="reconcile-customer-payments-with-the-cash-receipt-journal-or-from-customer-ledger-entries"></a><a name="reconcile-customer-payments-with-the-cash-receipt-journal-or-from-customer-ledger-entries"></a>Abstimmen von Debitoren-Zahlungen mit dem Zahlungseingangs Buch.-Blatt oder von Debitorenposten
...
## <a name="to-fill-and-post-a-cash-receipt-journal"></a><a name="to-fill-and-post-a-cash-receipt-journal"></a>So füllen Sie ein Zahlungseingangs Buch.-Blatt aus und buchen dieses
...
## <a name="to-correct-an-application-of-customer-entries"></a><a name="to-correct-an-application-of-customer-entries"></a>So heben Sie den Ausgleich von Debitorenposten auf
