...
# [!INCLUDE[d365fin_long](includes/d365fin_long_md.md)] einrichten, um die Mehrwertsteuer zu berechnen und zu buchen
<a id="setting-up-included365finlongincludesd365finlongmdmd-to-calculate-and-post-value-added-tax" class="xliff"></a>
...
## Es wird empfohlen, dass Sie die unterstützte Einrichtung verwenden, um die MwSt einzurichten.
<a id="use-the-vat-setup-assisted-setup-guide-to-set-up-vat-recommended" class="xliff"></a>
...
## Richten Sie MwSt.-Geschäftsbuchungsgruppen ein.
<a id="set-up-vat-business-posting-groups" class="xliff"></a>
...
<a id="set-up-vat-product-posting-groups" class="xliff"></a>
...
<a id="combine-vat-posting-groups-in-vat-posting-setups" class="xliff"></a>
...
<a id="assign-vat-posting-groups-by-default-to-multiple-entities" class="xliff"></a>
...
<a id="assign-vat-posting-groups-to-individual-accounts-customers-vendors-items-and-resources" class="xliff"></a>
...
<a id="to-assign-vat-posting-groups-to-individual-general-ledger-accounts" class="xliff"></a> 
...
<a id="to-assign-vat-business-posting-groups-to-customers-and-vendors" class="xliff"></a>  
...
<a id="to-assign-vat-product-posting-groups-to-individual-items-and-resources" class="xliff"></a>  
...
## Einrichten von Klauseln, um die Verwendung von nichtstandardisierten Mehrwertsteuersätzen zu erklären
<a id="set-up-clauses-to-explain-the-use-of-non-standard-vat-rates" class="xliff"></a>
...
<a id="to-set-up-vat-clauses" class="xliff"></a>
...
<a id="to-assign-a-vat-clause-to-a-vat-posting-setup" class="xliff"></a>
1. In der oberen rechter Ecke wählen Sie das Symbol **Nach Seite oder Bericht suchen** aus ![Nach Seite oder Bericht suchen](media/ui-search/search_small.png "Nach Seite oder Bericht suchen") und **MwSt-Buchungseinrichtungen** eingeben und den entsprechenden Link auswählen.  
...
<a id="to-specify-translations-for-vat-clauses" class="xliff"></a>
1. In der oberen rechter Ecke wählen Sie das Symbol **Nach Seite oder Bericht suchen** aus ![Nach Seite oder Bericht suchen](media/ui-search/search_small.png "Symbol nach Seite oder Bericht suchen"). Geben Sie **VAT-Codes** ein und wählen Sie dann den entsprechenden Link aus.  
...
<a id="create-a-vat-posting-setup-to-handle-import-vat" class="xliff"></a>
...
## MwSt-IdNr. prüfen
<a id="verify-vat-registration-numbers" class="xliff"></a>
...
<a id="using-reverse-charge-vat-for-trade-between-eu-countries-or-regions" class="xliff"></a>
...
**Hinweis:**Diese Regel gilt für den Handel mit Unternehmen, die in einem anderen EU-Land/in einer anderen EU-Region als umsatzsteuerpflichtig registriert sind. Wenn Sie direkt mit Verbrauchern in anderen EU-Ländern/-Regionen Geschäfte tätigen, sollten Sie sich bei den Steuerbehörden über die geltenden Regeln für die MwSt. informieren.  
...
<a id="sales-to-eu-countries-or-regions" class="xliff"></a>
...
## Machen Sie sich mit der MwSt.-Rundung für Belege vertraut.
<a id="understanding-vat-rounding-for-documents" class="xliff"></a>
