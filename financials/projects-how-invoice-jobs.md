...
<a id="how-to-invoice-jobs" class="xliff"></a>
...
<a id="to-create-and-post-a-job-sales-invoice" class="xliff"></a>
...
<a id="to-create-multiple-job-sales-invoices-from-job-planning-lines" class="xliff"></a>
...
<a id="to-calculate-and-post-job-completion-entries" class="xliff"></a>
