...
<a id="setting-up-cash-flow-analysis" class="xliff"></a>
...
<a id="the-cash-cycle-and-income--expense-charts" class="xliff"></a>
...
<a id="set-up-the-cash-flow-chart" class="xliff"></a>
...
<a id="set-up-cash-flow-forecasts" class="xliff"></a>
