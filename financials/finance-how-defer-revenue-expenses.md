...
<a id="how-to-defer-revenues-and-expenses" class="xliff"></a>
...
<a id="to-set-up-a-gl-account-for-deferral" class="xliff"></a>
...
<a id="to-set-up-a-deferral-template" class="xliff"></a>
...
<a id="to-assign-a-deferral-template-to-an-item" class="xliff"></a>
1. In der oberen rechter Ecke wählen Sie das Symbol **Nach Seite oder Bericht suchen** aus ![Nach Seite oder Bericht suchen](media/ui-search/search_small.png "Nach Seite oder Bericht suchen"). Geben Sie **Abgrenzungsvorlage** ein und wählen Sie dann den entsprechenden Link aus.
...
<a id="to-change-a-deferral-schedule-from-a-sales-invoice" class="xliff"></a>
...
<a id="to-preview-how-deferred-revenues-or-expenses-will-be-posted-to-the-general-ledger" class="xliff"></a>
...
<a id="to-review-posted-deferrals-in-the-sales-deferral-summary-report" class="xliff"></a>
