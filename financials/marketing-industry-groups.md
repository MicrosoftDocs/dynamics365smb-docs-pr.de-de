...
---
# Einrichten von Branchen für Kontaktunternehmen
<a id="setting-up-industry-groups-for-contact-companies" class="xliff"></a>
...
## Branchengruppencode definieren
<a id="to-define-an-industry-group-code" class="xliff"></a>
