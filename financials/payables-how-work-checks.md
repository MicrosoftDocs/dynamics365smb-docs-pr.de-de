...
<a id="how-to-work-with-checks" class="xliff"></a>
...
<a id="to-issue-checks" class="xliff"></a>
...
<a id="to-cancel-printed-checks-that-are-not-posted" class="xliff"></a>
...
<a id="to-void-checks" class="xliff"></a>
