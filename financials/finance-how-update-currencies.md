...
<a id="how-to-update-currency-exchange-rates" class="xliff"></a>
...
<a id="to-set-up-a-currency-exchange-rate-service" class="xliff"></a>
...
<a id="to-update-currency-exchange-rates-through-a-service" class="xliff"></a>
