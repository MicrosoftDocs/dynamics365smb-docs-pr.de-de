...
<a id="how-to-connect-and-disconnect-incoming-document-records-from-documents-and-entries" class="xliff"></a>
...
<a id="to-create-and-connect-an-incoming-document-record-from-a-purchase-invoice" class="xliff"></a>
...
<a id="to-create-and-connect-an-incoming-document-record-from-a-vendor-ledger-entry" class="xliff"></a>
...
<a id="to-remove-a-connection-from-an-incoming-document-record-to-a-posted-document" class="xliff"></a>
