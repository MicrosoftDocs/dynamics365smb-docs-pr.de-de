...
<a id="how-to-set-up-document-sending-profiles" class="xliff"></a>
...
<a id="to-set-up-a-document-sending-profile" class="xliff"></a>
...
<a id="to-specify-a-sending-profile-on-a-customer-card" class="xliff"></a>
