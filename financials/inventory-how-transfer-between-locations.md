...
<a id="how-to-transfer-inventory-between-locations" class="xliff"></a>
...
<a id="to-transfer-items-with-a-transfer-order" class="xliff"></a>
...
<a id="to-transfer-items-with-the-item-reclassification-journal" class="xliff"></a>
