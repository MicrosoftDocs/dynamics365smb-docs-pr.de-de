...
---
# So geht es: Erstellen von Nummernserien
<a id="how-to-create-number-series" class="xliff"></a>
...
<a id="to-create-a-new-number-series" class="xliff"></a>
...
<a id="to-set-up-where-a-number-series-is-used" class="xliff"></a>
...
<a id="to-create-relationships-between-number-series" class="xliff"></a>
